...
COPY --from=build /crew-station-back/crew-station-back/build/libs/crew-station-back-0.0.1-SNAPSHOT.jar crew-station-back.jar

# 포트 오픈 (Spring Boot 기본 포트)
EXPOSE 10000

# 실행 명령
ENTRYPOINT ["java", "-jar", "crew-station-back.jar"]